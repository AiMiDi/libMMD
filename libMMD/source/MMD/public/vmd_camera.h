...
namespace libmmd
{
	struct VMDCameraData
	{
		...
		VMDCameraInterpolator m_interpolator_distance{};
		// View Angle motion interpolation
		VMDCameraInterpolator m_interpolator_AOV{};
		// View Angle
		...
		explicit VMDCameraData(
			...
			m_interpolator_distance(std::move(interpolator_position_d)),
			m_interpolator_AOV(std::move(interpolator_position_v)) {}
	};
	...
	public:
		 ...
		 */
		explicit VMDCameraAnimation() : m_data(std::make_unique<data_type>()) {}
		/**
		 * \brief Constructor function
