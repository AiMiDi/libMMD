...
namespace libmmd
{
	struct PMXData
	{
		...
		explicit PMXData(std::u8string model_name_local = {}, std::u8string model_name_universal = {}, std::u8string	comments_local = {}, std::u8string	comments_universal = {}) :
	...
	public:
		 ...
		 */
		explicit PMX(std::u8string model_name_local = {}, std::u8string model_name_universal = {});
		/**
